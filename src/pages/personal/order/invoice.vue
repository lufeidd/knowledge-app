<template>
  <div id="invoicePage">
    <van-cell-group id="one">
      <van-cell title="订单号:" v-model="invoiceData.orderNumber" value="" is-link arrow-direction="down" />
      <van-cell title="发票类型:" v-model="invoiceData.invoiceType" value="" />
      <van-cell title="发票内容:" v-model="invoiceData.invoiceContent" value="" />
    </van-cell-group>
    <van-cell-group>
    <van-field
      clearable
...
export default {
  data () {
    return {
      username:'',
      type:{personal:false},
      invoiceData:{orderNumber:'4567892654',invoiceType:'电子发票',invoiceContent:'明细',companyName:'',number:'66',username:'',phone:''}
    }
  },
  methods:{
